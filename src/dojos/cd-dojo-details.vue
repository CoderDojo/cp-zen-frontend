    ...
    <div class="cd-dojo-details__container">
      ...
      <div class="cd-dojo-details__main_content">
        ...
        <section v-if="user && !dojoDetails.private" class="cd-dojo-details__section">
          ...
          <button @click="volunteer('mentor')" class="cd-dojo-details__volunteer-button" v-ga-track-click="{ eventCategory: $route.name, eventAction: 'click', eventLabel: 'volunteer_as_mentor' }">{{ $t('Volunteer as Mentor') }}</button>
          ...
          <button @click="volunteer('champion')" class="cd-dojo-details__volunteer-button" v-ga-track-click="{ eventCategory: $route.name, eventAction: 'click', eventLabel: 'volunteer_as_champion' }">{{ $t('Volunteer as Champion') }}</button>
        </section>
