<template>
  <div class="cd-find-dojo">
    <div v-bind:class="{ 'cd-find-dojo__panel': !searchExecuted, 'cd-find-dojo__panel--reduced': searchExecuted }">
      <form v-bind:class="{ 'cd-find-dojo__panel-form': !searchExecuted, 'cd-find-dojo__panel-form--reduced': searchExecuted }" @submit.prevent="$router.push({ query: { q: searchCriteria } });">
        ...
        <router-link tag="button" :to="{ query: { currentLocation: true } }" class="cd-find-dojo__panel-form-detect-location hidden-xs">
